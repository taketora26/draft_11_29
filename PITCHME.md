...
### `Scala`に詳しい方々の叡智がまとめられた本で、

### 単に原理ではなく、その背景や著者の視点が入った丁寧な解説が理解しやすさを促進しています。


---

## 入門者に向けては、確実に理解しやすい本ですし、
...
現場ではFutureを使った非同期処理が盛んに行われているかと思いますが、
その非同期処理についても、具体的な使い方を記載されています。
